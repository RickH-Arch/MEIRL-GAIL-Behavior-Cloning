...
#------------------------------------Initialize DMEIRL------------------------------------------
world.experts.ChangeTrajLenBias(0)
dme = DMEIRL(world,layers=(60,120,240,240,240,120,60),lr=0.00001,weight_decay=0.2,log=f'{utils.date}relu_bias{world.traj_len_bias}_v0.001_tp{world.trans_prob}_dis{world.discount}',log_dir='run_relu')

#------------------------------------Train------------------------------------------

dme.train(n_epochs=1000)

trans_prob_list = [0.6,0.7,0.8,0.9]
discount_list = [0.9,0.95,0.98]

# layers_list = [(60,120,240,120,60),(60,120,240,240,120,60)]
# wd_list = [0.2,0.5,1]
