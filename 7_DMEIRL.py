...
expert_traj_path = "wifi_track_data/dacang/track_data/trajs_0117_40x30.csv"
...
world = GridWorld(
                  ...
                  width=40, height=30,discount=0.95,trans_prob=0.6)
...
dme = DMEIRL(world,layers=(60,120,120,60),lr=0.00002,weight_decay=0.2,log=f'{utils.date}_v0.005_tp{world.trans_prob}_dis{world.discount}',log_dir='run')
